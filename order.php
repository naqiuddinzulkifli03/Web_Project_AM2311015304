...
<body>
	<form method="post" action="saveOrder.php" name="order"></form>
    <!-- Topbar Start -->
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">how to rent</h1>
        <div class="d-inline-flex text-white">
          <h6 class="text-uppercase m-0"><a class="text-white" href="">Home</a></h6>
            <h6 class="text-body m-0 px-3">/</h6>
            <h6 class="text-uppercase text-body m-0">order</h6>
      </div>
</div>
    <!-- Page Header Start -->
...
<div class="container-fluid py-5">
  <div class="container pt-5 pb-3">
    <h1 class="display-4 text-uppercase text-center mb-5">Step to Order and <span class="text-primary">Payment</span></h1>
  </div>

  <div class="d-flex justify-content-center">
    <a href="MySQL/rentalform.html" class="btn btn-primary py-md-3 px-md-5 mt-2">Click Here!</a>
  </div>
</div>
<!-- About End -->
    ...
    <!-- JavaScript Libraries --> <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.bundle.min.js"></script>
