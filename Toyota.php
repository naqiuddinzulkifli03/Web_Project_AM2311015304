...
<!-- Page Header Start -->
    <div class="container-fluid page-header">
        ...
        <div class="d-inline-flex text-white">
          <h6 class="text-uppercase m-0"><a class="text-white" href="">Home</a></h6>
            ...
            <h6 class="text-uppercase text-body m-0">toyota</h6>
        </div>
    </div>
    <!-- Page Header Start -->
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase text-center mb-5">toyota</h1>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="innova.png" alt="">
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item active mb-4">
                        ...
                        <h4 class="text-uppercase mb-4">toyota camry hybrid</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>2015</span>
                        ...
                        <a href="order.html"class="btn btn-primary px-3" href="">RM250/Day</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="fortuner.png" alt="">
                        ...
                        <a href="order.html" class="btn btn-primary px-3" href="">RM170/Day</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="altis.png" alt="">
                        <h4 class="text-uppercase mb-4">toyota altis&nbsp;</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>2015</span>
