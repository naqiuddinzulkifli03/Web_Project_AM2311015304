    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img src="Toyota Vios.png" alt="" width="804" height="528" class="img-fluid mb-4">
                        <h4 class="text-uppercase mb-4">Toyota Vios</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>2015</span>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        ...
                        <a href="order.php" class="btn btn-primary px-3" href="">RM170/Day</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
