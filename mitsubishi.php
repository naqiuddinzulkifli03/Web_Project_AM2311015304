            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item active mb-4">
                        ...
                        <a href="order.php" class="btn btn-primary px-3" href="">RM150/Day</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        ...
                        <a href="order.php" class="btn btn-primary px-3" href="">RM200/Day</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        ...
                        <a href="order.php"class="btn btn-primary px-3" href="">RM70/Day</a>
                    </div>
                </div>
            </div>
        </div>
