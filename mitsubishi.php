...
<!-- Page Header Start -->
    <div class="container-fluid page-header">
        ...
        <div class="d-inline-flex text-white">
          <h6 class="text-uppercase m-0"><a class="text-white" href="">Home</a></h6>
            ...
            <h6 class="text-uppercase text-body m-0">mitsubishi</h6>
        </div>
    </div>
    <!-- Page Header Start -->
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase text-center mb-5">mitsubishi</h1>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="mitsubishi 1.png" alt="">
                        <h4 class="text-uppercase mb-4">mitsubishi pajero 2019</h4>
                        ...
                        <a href="order.html" class="btn btn-primary px-3" href="">RM100/Day</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item active mb-4">
                        <img class="img-fluid mb-4" src="mitsubishi 2.png" alt="">
                        <h4 class="text-uppercase mb-4">mitsubishi triton 2018</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>2015</span>
                        ...
                        <a href="order.html" class="btn btn-primary px-3" href="">RM150/Day</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img src="mitsubishi lancer.png" alt="" width="1004" height="373" class="img-fluid mb-4">
                        <h4 class="text-uppercase mb-4">mitsubishi lancer 2016</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>2015</span>
                        ...
                        <a href="order.html" class="btn btn-primary px-3" href="">RM80/Day</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="lancer sportback.png" alt="">
                        <h4 class="text-uppercase mb-4">mitsubishi lancer sportback</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>2015</span>
                        ...
                        <a href="order.html" class="btn btn-primary px-3" href="">RM200/Day</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="mitsubishi xpander.png" alt="">
                        <h4 class="text-uppercase mb-4">mitsubishi xpander</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>2015</span>
                ...
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="mirage.png" alt="">
                        <h4 class="text-uppercase mb-4">Mitsubishi mirage&nbsp; 2017</h4>
                        <div class="d-flex justify-content-center mb-4">
                            <div class="px-2">
                                <i class="fa fa-car text-primary mr-1"></i>
                                <span>2015</span>
                        ...
                        <a href="order.html"class="btn btn-primary px-3" href="">RM70/Day</a>
                    </div>
                </div>
            </div>
        </div>
